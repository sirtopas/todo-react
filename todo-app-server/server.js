...
app.use(bodyParser.json()); mongoose.connect('mongodb+srv://cronus:Yk^eVfCwhn3qRWCd[nVcTYq3@cluster0-ysquu.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true });
